  ...
  "db-center": {
    ...
    da: [
      ...
      },
      {
        name: "Dockerode",
        description:
          "Bruges til nemt at oprette og køre databaser på brugerens enhed.",
        icon: "uil:docker",
        color: "#2494b6",
      },
      {
    ...
    da: [
      {
        title: "Database editor WIP",
        description:
          "Opret tabeller, slet tabeller, opdater data eller hent data gennem query runneren.",
        icon: "oui:editor-code-block",
      },
      {
        title: "Database oversigt",
        description:
          "Hold styr på alle dine databaser, se hvilke der kører, start og stop databaser nemt, og kopier forbindelsesstrengen.",
        icon: "bi:binoculars",
      },
      {
        title: "Opret databaser",
        description:
          "Opsæt nemt en MySQL og PostgreSQL database med blot et par klik. Appen starter derefter en Docker-container med MySQL, som du kan bruge.",
        icon: "proicons:database-add",
      },
    ],
  },
